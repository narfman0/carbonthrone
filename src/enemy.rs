...
impl Enemy {
    pub fn new(kind: EnemyKind, level: u32) -> Self {
        ...
        Self { name, kind, level, stats, current_hp, xp_reward, aggression }
    }
...
fn base_stats(kind: &EnemyKind) -> Stats {
    match kind {
        // Drifters
        EnemyKind::Scavenger        => Stats { max_hp: 40,  attack: 9,  defense: 3,  speed: 15 },
        EnemyKind::VoidRaider       => Stats { max_hp: 55,  attack: 12, defense: 5,  speed: 11 },
        EnemyKind::DrifterBoss      => Stats { max_hp: 95,  attack: 17, defense: 8,  speed: 7  },
        // Automata
        EnemyKind::MaintenanceDrone => Stats { max_hp: 65,  attack: 8,  defense: 10, speed: 7  },
        EnemyKind::SecurityUnit     => Stats { max_hp: 80,  attack: 13, defense: 11, speed: 9  },
        EnemyKind::CombatFrame      => Stats { max_hp: 280, attack: 24, defense: 20, speed: 10 },
        // Abyssal Fauna
        EnemyKind::MoonCrawler      => Stats { max_hp: 35,  attack: 11, defense: 2,  speed: 18 },
        EnemyKind::VoidSpitter      => Stats { max_hp: 55,  attack: 14, defense: 4,  speed: 10 },
        EnemyKind::AbyssalBrute     => Stats { max_hp: 160, attack: 13, defense: 15, speed: 4  },
        // Station Personnel
        EnemyKind::SalvageOperative => Stats { max_hp: 55,  attack: 9,  defense: 6,  speed: 10 },
        EnemyKind::GunForHire       => Stats { max_hp: 75,  attack: 15, defense: 9,  speed: 10 },
        EnemyKind::StationGuard     => Stats { max_hp: 65,  attack: 12, defense: 10, speed: 10 },
        EnemyKind::ShockTrooper     => Stats { max_hp: 100, attack: 19, defense: 13, speed: 8  },
    }
}
